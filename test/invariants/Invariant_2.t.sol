...
contract WETH_Handler_Based_Invariant_Tests is Test {
    ...
    function setUp() public {
        ...
        // Set fuzzer to only call functions in handler
        // reduce the reverts: [PASS] invariant_eth_balance() (runs: 256, calls: 3840, reverts: 1136)
    ...
    function invariant_eth_balance() public {
        // console.log("address(weth).balance:", address(weth).balance);
        // console.log("handler.wethBalance():", handler.wethBalance());
