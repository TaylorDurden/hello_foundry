...
contract MyDexTest is Test {
    ...
    function testAddLiquidity() public {
        ...
        // Check liquidity
        (uint reserveRNT, uint reserveWETH) = UniswapV2Library.getReserves(
            address(factory),
            tokenRNT,
            tokenWETH
        );
    ...
    function testRemoveLiquidity() public {
        ...
        // Check liquidity
        (uint reserveWETH, uint reserveRNT) = UniswapV2Library.getReserves(
            address(factory),
            tokenWETH,
            tokenRNT
        );
    ...
    function testBuyETHWithRNT() public {
        ...
        // Buy ETH
        myDex.buyETH(buyETHAmount, address(RNT));
    ...
    function _addLiquidityETH10_RNT1000()
        private
